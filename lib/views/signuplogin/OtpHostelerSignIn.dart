...
import 'package:hostelapp/views/Facilities/HostelerHomepageFunctionns/HostelerHomePage.dart';
  ...
  void signInWithPhoneNumber() async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => HostelerHomePage(
                widget.mobileNo, widget.roll, widget.name, widget.roomNo)),
      );
      print(widget.roll);
      otp.clear();
